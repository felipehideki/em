...
%% 1 b) HISTOGRAMAS E TESTE DE NORMALIDADE
figure 1;
hist(dados(1,:));
figure 2;
hist(dados(2,:));
...
%% 1 c) PLOT DOS DADOS DO PACIENTE COM O CONTROLE
mCMAP = 56;
mSNAP = 52;
uCMAP = 54;
uSNAP = 61;
...
%% 1 d) DISTRUBUIÇÃO NORMAL CUMULADA
...
%% 1 e) MATRIZ DE COVARIÂNCIA E PROBABILIDADE MULTIVARIADA CUMULADA
matcov = cov(dados');
...
%% 2 a) SENSIBILIDADE e 2 b) ESPECIFICIDADE
...
%% 2 e) ANÁLISE PARA TESTES NEGATIVOS
