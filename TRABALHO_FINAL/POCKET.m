function [wp,i,erro,indicesYe] = POCKET(xClasse1,xClasse2,max_iteracoes,rho)
...
%           erro: percentual de padrões classificados incorretamente
%           indicesYe: índices dos padrões classificados incorretamente
