 function [dadossim,classessim]=semana5_gerandodadosgaussianos(medias,covariancias, N,priors,plotar,seed)
...
% INPUT:
% -medias =  caracteristicas x classes (matriz contendo as medias das 
%    caracteristica para cada classe)
% -covariancia =  caracteristicas x caracteristicas x classes (matrizes de 
...
% - classessim= vetor 1 x N contendo o numero da classe (de 1 ate C) de 
